...
# Generated at Fri Sep 14 14:26:12 2012
...
# ------------------------------ Application
# ------------------------------ Security
#//<20121012-15050-Eric Lin, [secu] Modify the secu related features in modem.
SECURE_VERSION = 3
  # Description:
...
PROJECT_KEY_TYPE    = KEY_TYPE_DEV		# KEY_TYPE_MP,KEY_TYPE_DEV	
SECURE_CUSTOM_NAME = MOTDEVARIMA000005 
  # Description:
  #   Support security system
  # Option Values:
  #   JRD:
...
#//<2012/7/12-joshualee, integrate the RF driver customizations for the projects of 6575 and 6577 series
UMTS_BAND_VIII = FALSE #TRUE
  # Description:
...
#//<2012/11/6-joshualee,turn on the OTP definition for IMEI on modem side
OTP_SUPPORT = TRUE #FALSE
  # Description:
...
#//<2012/9/26-joshualee, enable the SECURE_RO and update AP modem images for HAWK and ARGONMINI series
SECURE_RO_ENABLE = TRUE
  # Description:
...
#//<2012/10/22-joshualee, turn on for the f1 new feature
#//<11/30-joshualee, for sim hotswap>
...
3G_CS_DELAY_OPTIMIZE_SUPPORT = FALSE    #
...
# *************************************************************************
RELEASE_PACKAGE = REL_CR_PROTOCOL_hspa # REL_CR_MMI_GPRS, REL_CR_MMI_GSM, REL_CR_L4_GPRS, REL_CR_L4_GSM
...
CUSTOM_OPTION += __UICC_CHANNEL_SUPPORT__

CUSTOM_OPTION += __CGLA__ __MM_REL6_COMBINED_RAU_TYPE__

CUSTOM_OPTION += __RAC_REPORT_LIMIT_AFTER_TRYALLPLMN__

CUSTOM_OPTION += __MM_COMPOSE_HIGH_QUALITY_PLMN_IN_DECREASING_ORDER__

CUSTOM_OPTION += __SAT_PROVIDE_CELL_IN_SIM__

#//<2013/3/4-rickjiau, Turn on this option to fix network issue. 
CUSTOM_OPTION += __DISABLE_NETWORK_LOST_OPTIMIZATION__
#//>2013/3/4-rickjiau

CUSTOM_OPTION += __DISABLE_NETWORK_ABNORMAL_OPTIMIZATION___

#//<2012/11/14-16921-jessicatseng, Enable the function of SIM man-in-the-middle
CUSTOM_OPTION += __TC02__  __TC02_SECURITY_REQUIREMENT__
#//>2012/11/14-16921-jessicatseng
...
COM_DEFS_FOR_ARIMA77_JB_LCM = ARIMA77_JB_LCM
...
EXISTED_CUS_REL_TRACE_DEFS += ps\rrlp\include\rrlp_trc.h 
...
EXISTED_CUS_REL_TRACE_DEFS += ps\cc-ss\cc\include\cc_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\cc-ss\ss\include\ciss_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\llc\include\llc_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\ppp\include\ppp_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\sm\include\sm_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\sms\include\sms_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\sndcp\include\snd_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\sim2\include\sim_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += sst\include\ex_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += sst\include\sst_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\ratcm\include\ratcm_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\ratdm\include\ratdm_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\rr2\lapdm\include\lapdm_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\rr2\mpal\include\mpal_trace.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\rr2\rlc\include\rlc_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\rr2\mac\include\mac_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\rr2\common\include\rr_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += tst\include\tst_trace.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\cmux\include\cmux_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\flc2\include\flc_trc.h 
...
#//<2012/10/29-15850-joshualee, forbid the all 2G and 3G bands in default for security requirement
CUSTOM_OPTION += ARIMA_FORBID_MD_BANDS_SECURITY
#//>2012/10/29-15850-joshualee

#//<2012/7/12-joshualee, integrate the RF driver customizations for the projects of 6575 and 6577 series
#CUSTOM_OPTION += ARGONMINI_6577
CUSTOM_OPTION += HAWK40
#//>2012/7/12-josuhalee
#<2012/11/30-joshualee
CUSTOM_OPTION += __ARIMA_SIM_SOCKET_H_L_H_INT__
#//>2012/11/30-joshualee
